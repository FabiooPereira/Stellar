...
void UCharacterMovementComponent::SetMaxWalkSpeed(float NewMaxWalkSpeed)
{
...
bool CharacterMovementComponent::CanDelaySendingMove(const FSavedMovePtr& NewMovePtr)
{
